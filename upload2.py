...
def save_uploadedfile(uploadedfile):
    with open(os.path.join('c:\\resume-git\\', uploadedfile.name), 'wb') as f:
...
uploaded_file = st.file_uploader('c:\\resume-git\\allfiles.sum')
...
with open('c:\\resume-git\\allfiles.sum') as f:
    st.write(f.readline())